...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Product.objects.create(
            id=1, name='Maggie 500g Packet', description='Nestle Maggie 500g noodle pack',
        ...
        Product.objects.create(
            id=2, name='Rice Bag 10Kg', description='Premium basmati rice 10kg bag',
        ...
        Product.objects.create(
            id=3, name='Sugar Bag 25Kg', description='Refined white sugar 25kg bag',
